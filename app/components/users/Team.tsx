...
export const Team = ({ id }: TeamProps) => {
  return (
    <section id={id || "team"} className="mt-10">
      {" "}
      <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6 mt-10">
        ...
        <div className="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          <div className="text-center text-gray-500 dark:text-gray-400">
            <Image
              src="/images/JayArPableo.jpg"
              alt="JayArPableo Avatar"
              className="mx-auto mb-4 w-36 h-36 rounded-full"
              width={36} 
              height={36}/>
            <h3 className="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
              <a href="#">Jay Ar Pableo</a>
            </h3>
            <p className="text-gray-500">Sorsogon State University</p>
            <p>BSCS Student</p>
            <ul className="flex justify-center mt-4 space-x-4">
              ...
              <li>
                <a
                  href="https://github.com/jaysepth08"
