        ...
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
          ...
          <div className="lg:hidden relative w-full">
            ...
            <div className="peer-checked:flex hidden lg:hidden flex-col mt-12 bg-white dark:bg-gray-800 absolute w-full left-0 top-0 z-10 rounded-lg shadow-md p-4">
              <Link href="/" className="block py-2 text-gray-700 dark:text-white">
                Home
              </Link>
              <Link href="/about" className="block py-2 text-gray-700 dark:text-gray-300">
                About
              </Link>
              <Link href="/team" className="block py-2 text-gray-700 dark:text-gray-300">
                Team
              </Link>
              <Link href="/contact" className="block py-2 text-gray-700 dark:text-gray-300">
                Contact
              </Link>
              <Link
                href="/login"
