...
export const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-b from-sky-50 to-sky-100 dark:from-gray-900 dark:to-gray-800">
            ...
            <div className="flex space-x-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className={`p-2 rounded-full bg-white dark:bg-gray-800 shadow-md transition-all duration-200 hover:scale-110 ${social.color}`}
